        ...
        <form method="POST" action="{{ route('proyectos.store') }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" id="nombre" name="nombre" class="form-control border-0 shadow @error('nombre') is-invalid @enderror" placeholder="¿Cuál es el proyecto?" value="{{ old('nombre')}}" />
                    @error('nombre')
                ...
                <div class="col-md-12 mt-3">
                    ...
                    <textarea id="descripcion" name="descripcion" class="form-control border-0 shadow @error('descripcion') is-invalid @enderror" rows="5">{{ old('descripcion')}}</textarea>
                    @error('descripcion')
                    <span class="d-block text-danger mt-2 font-weight-bold">{{ $message }}</span>
                    @enderror
                </div>
